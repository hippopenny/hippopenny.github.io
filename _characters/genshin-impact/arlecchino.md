...
quick_tricks:
  ...
  - "Track enemy movement before burst; she punishes missed openings more than low-commitment carries."
rotation_trick: "Pre-cast off-field buffs, swap to Arlecchino, run full normal combo string, then reset immediately before defensive uptime falls off."
daily_plan: "Farm one resin-efficient damage set domain first, then split resources between talent books and weapon ascension."
common_mistakes:
...
player_cta_copy: If you want a break from serious build planning, jump into Wacky Wisher and keep the Pyro chaos going.
gallery:
  - src: /assets/images/characters/genshin-impact/arlecchino.jpg
    label: "Carry mode"
...
strengths:
  ...
  - Great for players who want one character to dominate screen time.
weaknesses:
  - Less flexible than top-tier supports.
  - Wants team slots that protect her damage windows.
  - Not the safest recommendation for low-investment rosters.
best_for:
  - Players who prefer carry-centered teams.
  - Accounts with established support options.
  - Players who want a direct answer on whether she is still a top-end carry.
avoid_if:
  - You prioritize broad account flexibility.
  - You want a low-risk beginner recommendation.
  - You dislike characters that demand screen time and team support.
---
